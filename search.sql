...
--
-- Dumping data for table `geturl`
--

LOCK TABLES `geturl` WRITE;
/*!40000 ALTER TABLE `geturl` DISABLE KEYS */;
/*!40000 ALTER TABLE `geturl` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-06 19:27:20
